...
用法（作为库导入）：
    from repo_lens.scriptlib.offline_db_stub import FakeDB, SimpleTable, install_stub
...
CLI（自检，证明替身行为正确）：
    python -m repo_lens.scriptlib.offline_db_stub --self-test
    repolens.py script run offline_db_stub
