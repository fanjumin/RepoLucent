...
def render_html(data: dict) -> str:
    ...
    if dd:
        ...
        deep_html = (f"<h2>指定目标深度分析：{t} <code>{_e(dd['name'])}</code></h2>"
                     ...
                     f"<code>repolucent_deep_{_e(dd['name'])}.md / .json</code>。</p>")
...
<title>RepoLucent 仓库架构洞察报告</title>
<style>
...
<body><div class="wrap">
<h1>仓库架构洞察报告（RepoLucent）</h1>
<div class="meta">由 RepoLucent v{TOOL_VERSION} 自动生成 · {_e(meta['generated_at'])} ·
