...
用法：
    python -m repo_lucent.scriptlib.anchor_assert --against <repo> --claims claims.json [--json] [--stop-on-first]
    repolucent.py script run anchor_assert --against <repo> --claims claims.json
