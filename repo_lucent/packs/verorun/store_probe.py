...
用法：
    python -m repo_lucent.scriptlib.store_probe --base-url https://agent.easykai.cn
    repolucent.py script run store_probe --base-url https://<host> [--token-env VR_STORE_TOKEN] [--json]
"""
