...
(function () {
  ...
  function _authHeaders(extra) {
    ...
    if (window.__REPOLUCENT_TOKEN) h['X-RepoLucent-Token'] = window.__REPOLUCENT_TOKEN;
    return h;
  }
    ...
    settings() {
      return {
        html:
          ...
          '<div class="toolbar" style="align-items:flex-start">models JSON <textarea id="llmModels" rows="5" style="width:60%;font-family:monospace;font-size:.78rem" placeholder=\'[{"name":"qwen-plus","provider":"openai_compat","model":"qwen-plus","key_env":"REPO_LUCENT_DASHSCOPE_KEY","base_url_env":"REPO_LUCENT_DASHSCOPE_BASE_URL"}]\'></textarea></div>' +
