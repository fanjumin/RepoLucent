# -*- coding: utf-8 -*-
"""v2：现代 SaaS 仪表盘风格（深色导航 + 彩色指标卡 + SVG 环形图 + 角色徽章 + 渐变条形）。

数据刷新：重跑 `python insight.py` 后再次执行本脚本。
"""
import json
from collections import Counter
from pathlib import Path

SRC = Path(r"D:\projects\verorun-code\tools\dev_insight\out\verorun_insight.json")
DST = Path(r"D:\projects\verorun-code\tools\dev_insight\out\verorun_dashboard.html")
...
<div class="layout">
<aside class="side">
<div class="logo"><i></i>VeroRun Insight</div>
<div class="nav">
...
<div class="sub">verorun-code ＋ verorun-workplace · 数据由 dev-insight 自动采集 · 本地辅助工具，不入 Git</div></div></div>
...
print(f"仪表盘 v2 已生成: {DST} ({DST.stat().st_size/1024:.0f} KB)")
